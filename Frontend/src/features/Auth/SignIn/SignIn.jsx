...
const SignIn = () => {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans bg-neutral-950">
      ...
      {/* Background Image cho riêng cột trái */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Lớp phủ gradient từ trái qua phải để hòa quyện vào phần nội dung */}
        ...
        <div className="bg-white/3 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Google */}
              <button className="flex items-center justify-center gap-2 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white text-sm font-bold rounded-xl transition-all">
