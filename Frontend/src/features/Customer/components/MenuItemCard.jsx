// src/pages/Menu/components/MenuItemCard.jsx
import { Flame, ShoppingBag, Check } from "lucide-react";

export default function MenuItemCard({ item, added, onClick, onAdd }) {
      ...
      <div className="flex-1 flex flex-col justify-between py-1">
        ...
        <div className="flex justify-between items-end mt-2">
          ...
          <button
            ...
            title="Add to cart"
          >
            {added ? <Check size={18} className="animate-bounce" /> : <ShoppingBag size={18} />}
          </button>
        </div>
      </div>
    </div>
